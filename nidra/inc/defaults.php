...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			'top_bar_background_color' => '#1b1b1b',
			'top_bar_text_color' => '#cccccc',
			'top_bar_link_color' => '#eaeaea',
			'top_bar_link_color_hover' => '#cccccc',
			'header_background_color' => '#1b1b1b',
			'header_text_color' => '#cccccc',
			'header_link_color' => '#cccccc',
			'header_link_hover_color' => '#cccccc',
			'site_title_color' => '#eaeaea',
			'site_tagline_color' => '#cccccc',
			'navigation_background_color' => '#1b1b1b',
			'navigation_text_color' => '#eaeaea',
			...
			'subnavigation_background_color' => '#2b2b2b',
			'subnavigation_text_color' => '#eaeaea',
			...
			'fixed_side_content_background_color' => '#2b2b2b',
			'fixed_side_content_text_color' => '#cccccc',
			'fixed_side_content_link_color' => '#eaeaea',
			'fixed_side_content_link_hover_color' => '#cccccc',
			'content_background_color' => '',
			'content_text_color' => '',
			'content_link_color' => '',
			'content_link_hover_color' => '',
			'content_title_color' => '',
			'blog_header_bg_color' => '#1b1b1b',
			'blog_header_bg_s_color' => '#1b1b1b',
			'blog_header_title_color' => '#eaeaea',
			'blog_header_text_color' => '#cccccc',
			'blog_header_button' => '#eaeaea',
			'blog_header_button_bg' => '#2b2b2b',
			'blog_header_button_hover' => '#eaeaea',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#2b2b2b',
			'sidebar_widget_text_color' => '#cccccc',
			'sidebar_widget_link_color' => '#eaeaea',
			'sidebar_widget_link_hover_color' => '#cccccc',
			'sidebar_widget_title_color' => '#eaeaea',
			'footer_widget_background_color' => '#1b1b1b',
			'footer_widget_text_color' => '#cccccc',
			'footer_widget_link_color' => '#eaeaea',
			'footer_widget_link_hover_color' => '#cccccc',
			'footer_widget_title_color' => '#eaeaea',
			'footer_background_color' => '#1b1b1b',
			'footer_text_color' => '#cccccc',
			'footer_link_color' => '#eaeaea',
			...
			'form_button_background_color' => '#2b2b2b',
			'form_button_background_color_hover' => '#1b1b1b',
			'form_button_text_color' => '#eaeaea',
			'form_button_text_color_hover' => '#eaeaea',
			'back_to_top_background_color' => '#2b2b2b',
			'back_to_top_background_color_hover' => '#1b1b1b',
			'back_to_top_text_color' => '#eaeaea',
			'back_to_top_text_color_hover' => '#eaeaea',
		);
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			'font_body' => 'Oswald',
			'font_body_category' => '',
			'font_body_variants' => '200,300,regular,500,600,700',
			...
			'font_top_bar_variants' => '200,300,regular,500,600,700',
			'top_bar_font_weight' => '300',
			'top_bar_font_transform' => 'none',
			'top_bar_font_size' => '18',
			'font_site_title' => 'Righteous',
			...
			'font_blog_header_title' => 'Righteous',
			...
			'font_footer_variants' => '200,300,regular,500,600,700',
			'footer_weight' => '300',
			'footer_transform' => 'none',
			'footer_font_size' => '18',
			'font_fixed_side' => 'Oswald',
			'font_fixed_side_category' => '',
			'font_fixed_side_variants' => '200,300,regular,500,600,700',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Oswald:200,300,regular,500,600,700|Righteous:regular' );
